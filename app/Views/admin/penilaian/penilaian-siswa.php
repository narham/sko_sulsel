                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="pt-3 pl-3 pb-2">
                                    <h4><b>Tahun</b></h4>
                                    <input class="form-control" type="year" name="tahun" id="tahun" value="<?= date('Y'); ?>" onchange="onDateChange()">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script>
    ...
    function getDataPenilaian(idpenilaian, idsiswa) {
        jQuery.ajax({
            url: "<?= base_url('/admin/nilai-siswa/penilaian'); ?>",
            type: 'post',
            data: {
